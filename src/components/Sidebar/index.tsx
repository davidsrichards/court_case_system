    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/dashboard">
          <div className="group relative flex items-center gap-2.5 rounded-sm py-2  font-medium text-bodydark1 duration-300 ease-in-out">
            <GoLaw className="text-xl" />
            <h1 className="text-xl font-bold text-white/80">David</h1>
          </div>
        </NavLink>
